...
exports.addUser = async (req, res) => {
    const { name, email, password, confirmPassword } = req.body  //n'extraire que les champs requies pour  Validation 
...
exports.updatePassword = async (req, res) => {
    ...
    try{
        ...
        // Mise à jour de l'utilisateur
        let hash = await bcrypt.hash(req.body.newPassword, parseInt(process.env.BCRYPT_SALT_ROUND))
        User.update({ password: hash, confirmPassword: hash }, {
            where: {
                id: userId
            }
          });
